...
T = TypeVar("T", bound="ParallelSummaryInputPrices")


@_attrs_define
class ParallelSummaryInputPrices:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parallel_summary_input_prices = cls(
            raw=raw,
            psa_10=psa_10,
            psa_9=psa_9,
        )

        parallel_summary_input_prices.additional_properties = d
        return parallel_summary_input_prices
