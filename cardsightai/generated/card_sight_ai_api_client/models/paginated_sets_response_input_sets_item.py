...
T = TypeVar("T", bound="PaginatedSetsResponseInputSetsItem")


@_attrs_define
class PaginatedSetsResponseInputSetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_sets_response_input_sets_item = cls(
            id=id,
            name=name,
            is_identifiable=is_identifiable,
        ...
        paginated_sets_response_input_sets_item.additional_properties = d
        return paginated_sets_response_input_sets_item
