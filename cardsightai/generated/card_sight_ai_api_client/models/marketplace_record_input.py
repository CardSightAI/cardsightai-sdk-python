...
from ..models.marketplace_record_input_listing_type_type_0 import MarketplaceRecordInputListingTypeType0
from ..types import UNSET, Unset

T = TypeVar("T", bound="MarketplaceRecordInput")


@_attrs_define
class MarketplaceRecordInput:
    """
    Attributes:
        title (str): Listing title
        source (str): Marketplace source
        price (Union[None, Unset, float]): Current price or starting bid in USD
        listing_type (Union[MarketplaceRecordInputListingTypeType0, None, Unset]): Type of listing
    ...
    listing_type: Union[MarketplaceRecordInputListingTypeType0, None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.listing_type, Unset):
            listing_type = UNSET
        elif isinstance(self.listing_type, MarketplaceRecordInputListingTypeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_listing_type(data: object) -> Union[MarketplaceRecordInputListingTypeType0, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                listing_type_type_0 = MarketplaceRecordInputListingTypeType0(data)

                return listing_type_type_0
            except:  # noqa: E722
                pass
            return cast(Union[MarketplaceRecordInputListingTypeType0, None, Unset], data)
        ...
        marketplace_record_input.additional_properties = d
        return marketplace_record_input
