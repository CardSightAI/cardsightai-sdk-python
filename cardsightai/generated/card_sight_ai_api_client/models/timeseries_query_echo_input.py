...
T = TypeVar("T", bound="TimeseriesQueryEchoInput")


@_attrs_define
class TimeseriesQueryEchoInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        timeseries_query_echo_input = cls(
            interval=interval,
            periods=periods,
            as_of_date=as_of_date,
            listing_type=listing_type,
        ...
        timeseries_query_echo_input.additional_properties = d
        return timeseries_query_echo_input
