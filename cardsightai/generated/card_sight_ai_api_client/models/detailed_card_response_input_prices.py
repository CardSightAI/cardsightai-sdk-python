...
T = TypeVar("T", bound="DetailedCardResponseInputPrices")


@_attrs_define
class DetailedCardResponseInputPrices:
    """Average pricing data for the base card. Only included when price data is available. Prices are averaged across all
    available sources.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        detailed_card_response_input_prices = cls(
            raw=raw,
            psa_10=psa_10,
            psa_9=psa_9,
        )

        detailed_card_response_input_prices.additional_properties = d
        return detailed_card_response_input_prices
