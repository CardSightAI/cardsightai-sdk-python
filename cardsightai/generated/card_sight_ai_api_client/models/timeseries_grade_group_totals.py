...
T = TypeVar("T", bound="TimeseriesGradeGroupTotals")


@_attrs_define
class TimeseriesGradeGroupTotals:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        timeseries_grade_group_totals = cls()
        ...
        timeseries_grade_group_totals.additional_properties = additional_properties
        return timeseries_grade_group_totals
