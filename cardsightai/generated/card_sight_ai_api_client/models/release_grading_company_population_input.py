...
if TYPE_CHECKING:
    ...
    from ..models.release_set_rollup_input import ReleaseSetRollupInput


T = TypeVar("T", bound="ReleaseGradingCompanyPopulationInput")


@_attrs_define
class ReleaseGradingCompanyPopulationInput:
    """
    Attributes:
        ...
        grading_types (list['PopulationGradingTypeInput']): Aggregated populations across the entire release for this
            company
        sets (list['ReleaseSetRollupInput']): Per-set rollup. Sets with no data for this company are omitted.
    """
    ...
    sets: list["ReleaseSetRollupInput"]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for sets_item_data in _sets:
            sets_item = ReleaseSetRollupInput.from_dict(sets_item_data)

            sets.append(sets_item)

        release_grading_company_population_input = cls(
            id=id,
            name=name,
            last_synced_at=last_synced_at,
            total_population=total_population,
        ...
        release_grading_company_population_input.additional_properties = d
        return release_grading_company_population_input
