...
T = TypeVar("T", bound="MarketplaceMetaInput")


@_attrs_define
class MarketplaceMetaInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        marketplace_meta_input = cls(
            sources=sources,
            total_records=total_records,
        )

        marketplace_meta_input.additional_properties = d
        return marketplace_meta_input
