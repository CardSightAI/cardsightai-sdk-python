...
T = TypeVar("T", bound="RawTimeseriesSectionInputTotals")


@_attrs_define
class RawTimeseriesSectionInputTotals:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        raw_timeseries_section_input_totals = cls()
        ...
        raw_timeseries_section_input_totals.additional_properties = additional_properties
        return raw_timeseries_section_input_totals
