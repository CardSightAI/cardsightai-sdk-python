...
T = TypeVar("T", bound="CardDetailsInputParallel")


@_attrs_define
class CardDetailsInputParallel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        card_details_input_parallel = cls(
            id=id,
            name=name,
        ...
        card_details_input_parallel.additional_properties = d
        return card_details_input_parallel
