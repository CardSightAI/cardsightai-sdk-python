...
from ..models.search_result_match_kind import SearchResultMatchKind
...
class SearchResult:
    ...
    Attributes:
        ...
        match_kind (Union[Unset, SearchResultMatchKind]): Present on every result of the page only when close-spelling
            (fuzzy) matching engaged for this request: "exact" results matched the query directly and always sort before
            "fuzzy" results. Omitted entirely when fuzzy matching did not engage.
    """
    ...
    match_kind: Union[Unset, SearchResultMatchKind] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_kind: Union[Unset, SearchResultMatchKind]
        if isinstance(_match_kind, Unset):
            match_kind = UNSET
        else:
            match_kind = SearchResultMatchKind(_match_kind)
