...
T = TypeVar("T", bound="ParallelWithSetInputPrices")


@_attrs_define
class ParallelWithSetInputPrices:
    """Average pricing data for this parallel variant. Only included when price data is available.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parallel_with_set_input_prices = cls(
            raw=raw,
            psa_10=psa_10,
            psa_9=psa_9,
        )

        parallel_with_set_input_prices.additional_properties = d
        return parallel_with_set_input_prices
