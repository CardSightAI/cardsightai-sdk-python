...
T = TypeVar("T", bound="AggregatedGradingCompanyPopulationInput")


@_attrs_define
class AggregatedGradingCompanyPopulationInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        aggregated_grading_company_population_input = cls(
            id=id,
            name=name,
            last_synced_at=last_synced_at,
            total_population=total_population,
        ...
        aggregated_grading_company_population_input.additional_properties = d
        return aggregated_grading_company_population_input
