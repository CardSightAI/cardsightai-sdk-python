...
T = TypeVar("T", bound="FieldSummaryInput")


@_attrs_define
class FieldSummaryInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_summary_input.additional_properties = d
        return field_summary_input
