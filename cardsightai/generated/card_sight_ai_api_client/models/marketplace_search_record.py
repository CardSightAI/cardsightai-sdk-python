...
from ..models.marketplace_search_record_listing_type_type_0 import MarketplaceSearchRecordListingTypeType0
...
T = TypeVar("T", bound="MarketplaceSearchRecord")


@_attrs_define
class MarketplaceSearchRecord:
    """
    Attributes:
        title (str): Listing title
        source (str): Marketplace source
        price (Union[None, Unset, float]): Current price or starting bid in USD
        listing_type (Union[MarketplaceSearchRecordListingTypeType0, None, Unset]): Type of listing
    ...
    listing_type: Union[MarketplaceSearchRecordListingTypeType0, None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.listing_type, Unset):
            listing_type = UNSET
        elif isinstance(self.listing_type, MarketplaceSearchRecordListingTypeType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_listing_type(data: object) -> Union[MarketplaceSearchRecordListingTypeType0, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                listing_type_type_0 = MarketplaceSearchRecordListingTypeType0(data)

                return listing_type_type_0
            except:  # noqa: E722
                pass
            return cast(Union[MarketplaceSearchRecordListingTypeType0, None, Unset], data)
        ...
        return marketplace_search_record
