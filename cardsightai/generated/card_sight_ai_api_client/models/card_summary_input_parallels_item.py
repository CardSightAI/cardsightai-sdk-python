...
T = TypeVar("T", bound="CardSummaryInputParallelsItem")


@_attrs_define
class CardSummaryInputParallelsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        card_summary_input_parallels_item = cls(
            id=id,
            name=name,
            numbered_to=numbered_to,
        )

        card_summary_input_parallels_item.additional_properties = d
        return card_summary_input_parallels_item
