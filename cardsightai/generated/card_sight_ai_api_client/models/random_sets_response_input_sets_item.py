...
T = TypeVar("T", bound="RandomSetsResponseInputSetsItem")


@_attrs_define
class RandomSetsResponseInputSetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        random_sets_response_input_sets_item = cls(
            id=id,
            name=name,
            is_identifiable=is_identifiable,
        ...
        random_sets_response_input_sets_item.additional_properties = d
        return random_sets_response_input_sets_item
