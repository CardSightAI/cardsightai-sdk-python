...
T = TypeVar("T", bound="AddCardToBinderInput")


@_attrs_define
class AddCardToBinderInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_card_to_binder_input = cls(
            collection_card_id=collection_card_id,
        )

        add_card_to_binder_input.additional_properties = d
        return add_card_to_binder_input
