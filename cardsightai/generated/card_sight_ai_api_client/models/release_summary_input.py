...
T = TypeVar("T", bound="ReleaseSummaryInput")


@_attrs_define
class ReleaseSummaryInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        release_summary_input.additional_properties = d
        return release_summary_input
