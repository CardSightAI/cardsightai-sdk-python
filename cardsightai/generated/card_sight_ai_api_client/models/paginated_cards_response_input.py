...
@_attrs_define
class PaginatedCardsResponseInput:
    """
    Attributes:
        cards (list['CardSummaryInput']): Array of card entities with summary information
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for cards_item_data in _cards:
            cards_item = CardSummaryInput.from_dict(cards_item_data)
        ...
        return paginated_cards_response_input
