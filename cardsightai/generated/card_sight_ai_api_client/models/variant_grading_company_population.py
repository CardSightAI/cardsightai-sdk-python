...
T = TypeVar("T", bound="VariantGradingCompanyPopulation")


@_attrs_define
class VariantGradingCompanyPopulation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variant_grading_company_population = cls(
            id=id,
            name=name,
            last_synced_at=last_synced_at,
            total_population=total_population,
        ...
        return variant_grading_company_population
