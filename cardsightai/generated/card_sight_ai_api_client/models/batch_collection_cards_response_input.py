...
T = TypeVar("T", bound="BatchCollectionCardsResponseInput")


@_attrs_define
class BatchCollectionCardsResponseInput:
    """
    Attributes:
        cards (list['CollectionCardInput']): Successfully created cards
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_collection_cards_response_input = cls(
            cards=cards,
            errors=errors,
        )

        batch_collection_cards_response_input.additional_properties = d
        return batch_collection_cards_response_input
