...
from ...models.detailed_parallel_response import DetailedParallelResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DetailedParallelResponse.from_dict(response.json())

        return response_200

    if response.status_code == 201:
        response_201 = DetailedParallelResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DetailedParallelResponse, ErrorResponse]
    """
