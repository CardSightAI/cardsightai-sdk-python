...
def sync_detailed(
    *,
    ...
    """Card name autocomplete
     ...
     Get card name suggestions for autocomplete. Can filter by set, release, or broader filters. Returns
    up to 10 unique card names sorted alphabetically.
