...
def sync_detailed(
    *,
    ...
    """Year autocomplete
     ...
     Get year suggestions for autocomplete. Can filter by segment and/or manufacturer. Returns up to 10
    matching years sorted chronologically.
