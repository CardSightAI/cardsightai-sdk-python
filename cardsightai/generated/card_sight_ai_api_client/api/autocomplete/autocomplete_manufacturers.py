...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/autocomplete/manufacturers",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Manufacturer name autocomplete
     ...
     Get manufacturer name suggestions for autocomplete. Can filter by segment. Returns up to 10 matching
    manufacturer names sorted alphabetically.
